...
const Error = () => {
  ...
  return (
    <div className="flex flex-col w-full h-[100vh] ">
      <div className="w-full flex pt-[20px] justify-center">
        <Link to="">
          <div
            className=" bg-[darkorange] text-[white] font-[700] text-[25px]w-[150px] p-[10px]  h-[35px] flex items-center justify-center rounded-md z-[999] "
            onClick={() => {
              dispatch(logOut());
            }}
          >
